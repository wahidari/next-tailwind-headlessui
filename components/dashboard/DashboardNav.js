...
export default function DashboardNav() {
  ...
  return (
    ...
    <nav className="flex max-w-screen-2xl mx-auto px-2 sticky top-0 z-10 bg-white dark:bg-neutral-900 border-b dark:border-b-neutral-800">
      <div className="px-2 w-full my-2 flex justify-between">
        <div className="flex gap-2 dark:text-white font-medium">
        ...
        <div className="sm:flex gap-2 dark:text-white text-sm font-medium hidden">
          <Link href="/dashboardd">
            <a className="px-2 rounded hover:bg-gray-100 flex items-center">Menu</a>
          </Link>
          <Popover className="relative hover:bg-gray-100 rounded flex items-center">
            {({ open }) => (
              <>
                ...
                >
                  <Popover.Panel className="absolute bg-white shadow space-y-1 top-9 right-0 px-2 py-2 rounded w-40 z-10">
                    <ActiveLink activeClassName="bg-gray-100" href="/dashboard">
                      <a className="block px-3 py-1 rounded-md text-sm font-medium hover:bg-gray-100 transition-all">Dashboard</a>
                    </ActiveLink>
                    <ActiveLink activeClassName="bg-gray-100" href="/dashboardd">
                      <a className="block px-3 py-1 rounded-md text-sm font-medium hover:bg-gray-100 transition-all">Dashboardd</a>
                    </ActiveLink>
                  </Popover.Panel>
                </Transition>
              </>

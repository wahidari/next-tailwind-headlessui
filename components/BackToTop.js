...
export default function BackToTop() {
    ...
    return (
        <>
            {showBackToTop &&
                <div className="!py-2 px-2 rounded mx-4 bg-opacity-20 dark:bg-opacity-40 bg-gray-100 dark:bg-neutral-800 backdrop-filter backdrop-blur fixed bottom-6 md:bottom-1/4 right-3 md:right-10 z-40">

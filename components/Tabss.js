				...
				<Tab.List className="w-full max-w-md flex space-x-1 bg-transparent rounded-t dark:border-gray-500 font-medium z-10">
					{tabs.map(item => (
						<Tab key={item}
							className={({ selected }) =>
								classNames(
									'w-full mr-2 py-2 text-base font-medium text-dark-500 bg-gray-100 dark:bg-neutral-900 rounded-t border dark:border-gray-700 transition-all duration-300',

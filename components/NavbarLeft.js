      ...
      <Popover as="nav" className="shadow">
        <>
              ...
              <div className="hidden md:block">
                <div className="ml-10 flex items-baseline space-x-4">
                  <ActiveLink activeClassName="bg-blue-500 text-white" href="/">
                    <a className="px-3 py-1 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100">First</a>
                  </ActiveLink>
                  <ActiveLink activeClassName="bg-blue-500 text-white" href="/second">
                    <a className="px-3 py-1 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100">Second</a>
                  </ActiveLink>
                  <Popover className="relative">
                    {({ open }) => (
                      <>
                        <Popover.Button className="group flex space-x-2 items-center px-2 py-1 rounded-md text-base font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-800 transition-colors duration-200">
                          <span>More</span>
                          <ChevronDownIcon
                        ...
                        >
                          <Popover.Panel className="absolute bg-white shadow space-y-1 top-12 px-2 py-2 rounded w-40">
                            <ActiveLink activeClassName="bg-blue-500 text-white" href="/third">
                              <a className="block px-3 py-1 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100">Third</a>
                            </ActiveLink>
                            <ActiveLink activeClassName="bg-blue-500 text-white" href="/fourth">
                              <a className="block px-3 py-1 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100">Fourth</a>
                            </ActiveLink>
                          </Popover.Panel>
                        </Transition>
                      </>
          ...
          >
            ...
            >
              <div className="rounded-lg px-2 shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">

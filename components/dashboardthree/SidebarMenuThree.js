...
export default function SidebarMenuThree() {
  ...
  return (
    <aside className={`w-52 hidden ${showSidebarMenu ? "lg:block" : ""} fixed inset-y-0 border-r dark:border-r-neutral-800`}>

        <div className="px-6 py-1 flex gap-x-2 items-center border-b dark:border-b-neutral-800">
          <p className="font-medium dark:text-white py-1.5">Dashboard Three</p>
        </div>

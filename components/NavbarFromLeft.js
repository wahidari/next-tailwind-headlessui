          ...
          <div className="flex-shrink-0">
            <Link href="/">
              <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-9 h-9 text-white p-2 bg-blue-500 rounded-full" viewBox="0 0 1000 1000" fill="none">
            ...
            <div className="pointer-events-none fixed inset-y-0 left-0 flex max-w-full pr-16">
              ...
              >
                <div className="pointer-events-auto relative w-screen max-w-md">
                  {/* Close Panel Button  */}
                  <div className="absolute top-0 right-0 flex pt-6 mr-5">
                    <button
                      type="button"
                    ...
                    <div className="relative mt-6 flex-1 px-4 sm:px-6">
                      ...
                      <div className="absolute inset-0 px-4 sm:px-6">
                        <div className="h-full" aria-hidden="true">
                          <ActiveLink activeClassName="text-gray-800" href="/">
                            <a className="border-b-1 block py-2 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100">First</a>
                          </ActiveLink>
                          <hr/>
                          <ActiveLink activeClassName="text-gray-800" href="/second">
                            <a className="border-b-1 block py-2 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100">Second</a>
                          </ActiveLink>
                          <hr/>
                          <Menu>
                            {({ open }) => (
                              <>
                                <Menu.Button className="border-b-1 w-full py-2 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100">
                          ...
                          <ActiveLink activeClassName="text-gray-900" href="/nav-bar">
                            <a className="border-b-1 block py-2 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100">Navbar</a>
                          </ActiveLink>
                          <hr/>
                          <div className="pt-2">

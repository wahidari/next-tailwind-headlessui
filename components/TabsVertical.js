				...
				<Tab.List className="bg-transparent dark:border-gray-500 font-medium">
					{tabs.map(item => (
						<Tab key={item}
							className={({ selected }) =>
								classNames(
									'w-full mb-2 py-2 text-base font-medium text-dark-500 bg-gray-100 dark:bg-neutral-900 rounded sm:rounded-r-none border dark:border-gray-700 transition-all duration-300',
